...
export function LoginPage() {
  ...
  if (user) return <Navigate to="/scenes" replace />
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-bg px-4">
      <div className="text-center space-y-6">
        ...
        <button
          ...
          className="mt-8 px-8 py-3 bg-white text-gray-800 rounded-xl font-semibold text-base hover:bg-gray-100 transition-colors flex items-center gap-3 mx-auto"
        >
